...
// warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-NEBDS2U0;Database=RentKendaraan;Trusted_Connection=True;MultipleActiveResultSets=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdCustomerr);

                entity.Property(e => e.IdCustomerr).HasColumnName("ID_Customerr");
