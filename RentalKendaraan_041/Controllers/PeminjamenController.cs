...
namespace RentalKendaraan_041.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        {
            ViewData["IdCostumer"] = new SelectList(_context.Customer, "IdCustomerr", "IdCustomerr");
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCostumer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
            ...
            ViewData["IdCostumer"] = new SelectList(_context.Customer, "IdCustomerr", "IdCustomerr", peminjaman.IdCostumer);
